...
KANGING_STR = [
    "Stikernya Bagus Ni Anjing",
    "Colong Lah Bangsattt",
]
...
async def kang(args):
    ...
    if message and message.media:
        if isinstance(message.media, MessageMediaPhoto):
            ...
            return await args.edit("`File Tidak Didukung Kontol!`")
    else:
        return await args.edit("`Maaf Tot, Saya Gagal Mengambil Sticker Ini!`")
    ...
    if photo:
        ...
        if (
            ...
            async with bot.conversation("Stickers") as conv:
                ...
                if "Sorry, the file type is invalid." in rsp.text:
                    return await args.edit(
                        "`Maaf Tot, Saya Gagal Menambahkan Sticker, Gunakan` @Stickers ` Bot Untuk Menambahkan Sticker Anda.`"
                    )
                await conv.send_message(emoji)
                # Ensure user doesn't get spamming notifications
                await bot.send_read_acknowledge(conv.chat_id)
            ...
            async with bot.conversation("Stickers") as conv:
                ...
                if "Sorry, the file type is invalid." in rsp.text:
                    return await args.edit(
                        "`Mohon Maaf Tot, Saya Gagal Menambahkan Sticker, Gunakan` @Stickers ` Bot Untuk Menambahkan Sticker.`"
                    )
                await conv.send_message(emoji)
                # Ensure user doesn't get spamming notifications
                await bot.send_read_acknowledge(conv.chat_id)
        ...
        await args.edit(
            f"**Mampus Kontol Udah Gua Ambil Stikernya, Teken** **[Stiker Colongan Kontol](t.me/addstickers/{packname})** **Buat liat Pack Lu Goblok**",
            parse_mode="md",
        )
...
async def get_pack_info(event):
    if not event.is_reply:
        return await event.edit(
            "`Bales Ke Stiker Tolol`"
        )

    rep_msg = await event.get_reply_message()
    if not rep_msg.document:
        return await event.edit("`Bales ke stiker `")
...
async def sticker_to_png(sticker):
    ...
    try:
        ...
        await sticker.edit("`Maaf Tot, Ini Bukanlah Sticker`")
        return
