...
async def killdabot(event):
    ...
    await event.edit("`Mematikan Crash-Userbot....`")
    await asyncio.sleep(7)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#SHUTDOWN \n"
                                        "`Crash-Userbot Telah Dimatikan`")
    await bot.disconnect()


@register(outgoing=True, pattern="^.restart$")
async def killdabot(event):
    await event.edit("`Restarting Crash-Userbot...`")
    await asyncio.sleep(10)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#RESTARTBOT \n"
                                        "`Crash-Userbot Telah Di Restart`")
    await bot.disconnect()
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "༒︎ **Repo Userbot:** [Crash-Userbot](https://github.com/xrrmli/Crash-Userbot)\n༒︎ **Pemilik:** [Ramli](t.me/mentalbrikden)"
    )
